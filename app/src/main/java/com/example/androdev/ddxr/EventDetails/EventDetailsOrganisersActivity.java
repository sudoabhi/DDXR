...
public class EventDetailsOrganisersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventReference.child(EventKey).child("Organisers").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                posts.add(new EventDetailsOrganisersData(Name, Role, Phone, Email,Pic));
