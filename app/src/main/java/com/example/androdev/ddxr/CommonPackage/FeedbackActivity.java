...
public class FeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        feedbackDB= FirebaseDatabase.getInstance("https://ddrx-feedback-172d3.firebaseio.com/");
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(nameS)||TextUtils.isEmpty(phoneS)||TextUtils.isEmpty(emailS)
                    ...
                    Toast.makeText(FeedbackActivity.this, "Please fill in the empty fields", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    ...
                    Toast.makeText(FeedbackActivity.this, "Thank you for the feedback. We promise to enhance customer experience.", Toast.LENGTH_SHORT).show();
                    finish();
        ...
        if (ContextCompat.checkSelfPermission(FeedbackActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(FeedbackActivity.this,
                ...
                Toast.makeText(FeedbackActivity.this, "This is very necessary", Toast.LENGTH_SHORT).show();
    ...
    public void UploadScreenshot(){
        ...
        builder = new AlertDialog.Builder(FeedbackActivity.this, R.style.AlertDialogTheme);
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK) {
                    ...
                    new FeedbackActivity.CompressionAsyncTask(selectedImage, selectedImageS).execute();
    ...
    private class CompressionAsyncTask extends AsyncTask<Uri, Integer, Void> {
        ...
        protected Void doInBackground(Uri... params) {
            try {
                original = MediaStore.Images.Media.getBitmap(FeedbackActivity.this.getContentResolver(), selectedImage);
            } catch (IOException e) {
            }
