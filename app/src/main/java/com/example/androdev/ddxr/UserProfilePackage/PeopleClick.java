package com.example.androdev.ddxr.UserProfilePackage;
...
import com.example.androdev.ddxr.IntroPackage.ScreenActivity;
import com.example.androdev.ddxr.UserActivities.CustomViewPager2;
...
public class PeopleClick extends AppCompatActivity {
   ...
   // String SearchedUID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_fragment_profile2);
       ...
       LL_following=(LinearLayout) findViewById(R.id.LL_following);
        ...
        share_profile=(FloatingActionButton)findViewById(R.id.share_profile);
        ...
        blog_database = FirebaseDatabase.getInstance("https://ddrx-172d3-2a5f7.firebaseio.com/");
        ...
        LL_followers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Integer.parseInt(FollowersCount.getText().toString())!=0){
                    ...
                    Intent intent=new Intent(PeopleClick.this, InterestedPeople.class);
                    intent.putExtra("UserUID",SearchedUIDX);
        ...
        share_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String uri="http://hungryhunter96.github.io/profile?Key="+SearchedUIDX;
                ...
                Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                        ...
                        .addOnCompleteListener(PeopleClick.this, new OnCompleteListener<ShortDynamicLink>() {
                            @Override
                            public void onComplete(@NonNull Task<ShortDynamicLink> task) {
                                if (task.isSuccessful()) {
                                    //   progress_edit_delete.setVisibility(View.GONE);

                                    Toast.makeText(PeopleClick.this,"Profile link copied",Toast.LENGTH_SHORT).show();

                                    Uri shortLink = task.getResult().getShortLink();
                                    Uri flowchartLink = task.getResult().getPreviewLink();

                                    ClipboardManager clipboard = (ClipboardManager) PeopleClick.this.getSystemService(Context.CLIPBOARD_SERVICE);
                                    ...
                                    Toast.makeText(PeopleClick.this,"Link Copy Failure",Toast.LENGTH_SHORT).show();
                ...
                if(follow_bt.getText().equals("Follow")){
                    ...
                    parentReference.child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            String ClubLocationS=dataSnapshot.child("ClubLocation").getValue(String.class);
                            String UserNameS=dataSnapshot.child("UserName").getValue(String.class);
                            parentReference.child(SearchedUIDX).child("Followers").child(user.getUid()).child("ImageUrl").setValue(ImageS);
                            parentReference.child(SearchedUIDX).child("Followers").child(user.getUid()).child("UserName").setValue(UserNameS);
                            parentReference.child(SearchedUIDX).child("Followers").child(user.getUid()).child("ClubLocation").setValue(ClubLocationS);
                            parentReference.child(SearchedUIDX).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                                    String ImageSS= dataSnapshot2.child("ImageUrl").getValue(String.class);
                                    String ClubLocationSS=dataSnapshot2.child("ClubLocation").getValue(String.class);
                                    String UserNameSS=dataSnapshot2.child("UserName").getValue(String.class);
                                    parentReference.child(user.getUid()).child("Following").child(SearchedUIDX).child("ImageUrl").setValue(ImageSS);
                                    parentReference.child(user.getUid()).child("Following").child(SearchedUIDX).child("UserName").setValue(UserNameSS);
                                    parentReference.child(user.getUid()).child("Following").child(SearchedUIDX).child("ClubLocation").setValue(ClubLocationSS).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                follow_bt.setText("Following");
                                                progressBarX.setVisibility(View.GONE);
                                                int s=Integer.parseInt(FollowersCount.getText().toString());
                                                FollowersCount.setText(""+(s+1));
                                            }
                                            else{
        ...
        alertDialogBuilder.setTitle("Attention !")
                ...
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(PeopleClick.this,"Club Deleted",Toast.LENGTH_LONG).show();
