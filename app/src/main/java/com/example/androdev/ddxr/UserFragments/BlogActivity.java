    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(EventKeyM==null){
            if(state!=null&&state.equals("Students")) {
                blogReference = FirebaseDatabase.getInstance("https://ddrx-172d3-2a5f7.firebaseio.com/").getReference();
            }
            if(state!=null&&state.equals("Organizers")) {
                blogReference = FirebaseDatabase.getInstance("https://organizersblog.firebaseio.com/").getReference();
            }
        }
        else{
            blogReference = FirebaseDatabase.getInstance("https://eventdiscussions.firebaseio.com/").getReference(EventKeyM);
        }
        ...
        author_intro2=findViewById(R.id.author_intro2);
        ...
        mAdapter = new RecycleAdapter(comments);
          ...
          author_intro.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  if(state.equals("Students")){
                      ...
                      intent.putExtra("UserUID",UploadedBy);
                      startActivity(intent);
                  }
                  if(state.equals("Organizers")){
                      Intent intent = new Intent(BlogActivity.this, ClubDetails.class);
                      intent.putExtra("ClubUID", UploadedBy);
                      startActivity(intent);
                  }
...
*/
        ...
        getBlogDetails(new FirebaseCallbackXX() {
            ...
            public void onCallBack3(String string) {
                ...
                Toast.makeText(BlogActivity.this,"h"+UserName.length(),Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onCallBack13(String string){
            ...
            @Override
            public void onCallBack14(String string){
                if(string.equals("true")){
                    X11="Disabled";
                }
                if(string.equals("false")){
  ...
  participant_count.setOnClickListener(new View.OnClickListener() {
    ...
    class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.blog_discussions, parent, false);
                    ...
                    parentReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.hasChild(c.getUserUID())){
                                ...
                                Intent i=new Intent(BlogActivity.this,ClubDetails.class);
                                i.putExtra("ClubUID",c.getUserUID());
                                startActivity(i);
                            }
                        }
    ...
    public void getBlogDetails(final FirebaseCallbackXX  firebaseCallbackXX){
        ...
        blogReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.child(key).child("LikeStatus").hasChild(user.getUid())) {
                    String like_stat = dataSnapshot.child(key).child("LikeStatus").child(user.getUid()).getValue(String.class);
                    firebaseCallbackXX.onCallBack13(like_stat);
                }
                if(dataSnapshot.child(key).child("DislikeStatus").hasChild(user.getUid())) {
                    String DislikeS = dataSnapshot.child(key).child("DislikeStatus").child(user.getUid()).getValue(String.class);
                    firebaseCallbackXX.onCallBack14(DislikeS);
                }
