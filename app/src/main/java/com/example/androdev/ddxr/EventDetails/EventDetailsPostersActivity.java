...
public class EventDetailsPostersActivity extends AppCompatActivity {
    ...
    List<EventDetailsPostersData> list;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        eventReference.child(key).child("Posters").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                list.add(new EventDetailsPostersData(Pic,Pic_Key));
    ...
    class EventDetailsPosterAdapter extends RecyclerView.Adapter<EventDetailsPosterAdapter.MyViewHolder> {

        private List<EventDetailsPostersData> postersList;
        Context context;
        ...
        public EventDetailsPosterAdapter(Context context, List<EventDetailsPostersData> postersList) {
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder viewHolder, final int position) {
            ...
            EventDetailsPostersData data = postersList.get(position);
