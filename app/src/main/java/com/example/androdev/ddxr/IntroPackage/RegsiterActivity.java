...
public class RegsiterActivity extends AppCompatActivity {
    ...
    RelativeLayout inner2;
        ...
        private void createUser(final String emailS, final String passwordS){
        ...
        public void buttonchange() {
            if (!(email.getText().toString().equals("") || password.getText().toString().equals(""))) {
                ...
                register.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.buttonEnable2));
                ...
                register.setEnabled(false);
                register.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.buttonDisable));
                register.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.disableButtonText));
