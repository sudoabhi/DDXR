...
public class AddPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       EventNameXX=i.getStringExtra("EventNameXX");
        ...
        getSupportActionBar().setTitle("Start a conversation");
        ...
        if(EventKeyX==null){
            ...
            blog_database=FirebaseDatabase.getInstance("https://eventdiscussions.firebaseio.com/");
            blog_reference = blog_database.getReference(EventKeyX);
        }
        parentDatabase = FirebaseDatabase.getInstance("https://ddrx-172d3.firebaseio.com/");
        ...
        if(EventKeyX==null){
            ...
            //Add hints here here for event discussions
        }

        mRecyclerView = (RecyclerView) findViewById(R.id.my_recycler_view);
        mAdapter = new MyAdapter(AddPost.this, post_hints);
        ...
        /*blog_et.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (blogs.length() == 0) {
            ...
            parentReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ImageUrl = dataSnapshot.child(user.getUid()).child("ImageUrl").getValue(String.class);
                    ...
                    blog_node_reference.updateChildren(newBlog).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(EventKeyX==null){
                                /*Intent intent=new Intent(AddPost.this,MainUserActivity.class);
    ...
    public void initializeEditText(){
        ...
        //blog_et.setFocusableInTouchMode(true);
        blog_et.requestFocus();
        InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED, 0);
        //blog_et.setCursorVisible(true);
