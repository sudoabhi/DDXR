...
public class PasswordActivity extends AppCompatActivity {
    ...
    public void buttonchange() {
        if (Email.getText().toString().equals("")) {
            btnNewPass.setEnabled(false);
            btnNewPass.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.buttonDisable));
            btnNewPass.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.disableButtonText));
        }
        else {
            btnNewPass.setEnabled(true);
            btnNewPass.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.buttonEnable));
