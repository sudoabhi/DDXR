...
public class PhotoSelector extends AppCompatActivity implements UCropFragmentCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(activity.equals("SignUpActivity")){
            title.setText("User Profile Photo");
            aspectT.append("1:1 )");
        }
        if(activity.equals("FragmentProfile")){
            title.setText("User Profile Photo");
            aspectT.append("1:1 )");
        }
    ...
    private UCrop basisConfig(@NonNull UCrop uCrop) {
        ...
        else if(activity.equals("FragmentProfile")) {
            uCrop = uCrop.withAspectRatio(1, 1);
            uCrop = uCrop.withMaxResultSize(800, 800);
    ...
    private void handleCropResult(@NonNull Intent result) {
        ...
        if (resultUriS != null) {
            ...
            if(activity.equals("SignUpActivity")) {
                Intent intent = new Intent("SignUpPhotoSelector");
                intent.putExtra("SignUpProfileStringUri", resultUriS);
                setResult(RESULT_OK, intent);
                finish();

            }
            if(activity.equals("FragmentProfile")) {
                Intent intent = new Intent("FragmentProfilePhotoSelector");
                intent.putExtra("FragmentProfileStringUri", resultUriS);
                setResult(RESULT_OK, intent);
                finish();
